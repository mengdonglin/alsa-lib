...
static int parse_compound(snd_tplg_t *tplg, snd_config_t *cfg,
...
snd_tplg_t *snd_tplg_new(const char *name, int verbose)
{
	snd_tplg_t *tplg;
	int fd;
...
static struct tplg_elem* create_elem_common(snd_tplg_t *tplg,
 ...
 *	}
 */
static int parse_data(snd_tplg_t *tplg, snd_config_t *cfg,
 ...
 *	}
 */
static int parse_text(snd_tplg_t *tplg, snd_config_t *cfg,
	void *private ATTRIBUTE_UNUSED)
{
	snd_config_iterator_t i, next;
	snd_config_t *n;
 ...
 * }
 */
static int parse_channel(snd_tplg_t *tplg ATTRIBUTE_UNUSED,
 ...
 * }
 */
static int parse_ops(snd_tplg_t *tplg ATTRIBUTE_UNUSED,
	snd_config_t *cfg, void *private)
{
	snd_config_iterator_t i, next;
	snd_config_t *n;
 ...
 *	}
 */
static int parse_tlv(snd_tplg_t *tplg, snd_config_t *cfg,
	void *private ATTRIBUTE_UNUSED)
{
	snd_config_iterator_t i, next;
	snd_config_t *n;
 ...
 * }
 */
static int parse_control_bytes(snd_tplg_t *tplg,
 ...
 * }
 */
static int parse_control_enum(snd_tplg_t *tplg, snd_config_t *cfg,
	void *private ATTRIBUTE_UNUSED)
{
 ...
 * }
 */
static int parse_control_mixer(snd_tplg_t *tplg,
	snd_config_t *cfg, void *private ATTRIBUTE_UNUSED)
{
 ...
 * }
 */
static int parse_dapm_widget(snd_tplg_t *tplg,
	snd_config_t *cfg, void *private ATTRIBUTE_UNUSED)
{
 ...
 * }
 */
static int parse_pcm_config(snd_tplg_t *tplg,
	snd_config_t *cfg, void *private ATTRIBUTE_UNUSED)
{
 ...
 * } 
 */
static int parse_pcm_caps(snd_tplg_t *tplg,
	snd_config_t *cfg, void *private ATTRIBUTE_UNUSED)
{
 ...
 * }
 */
static int parse_pcm_cap_cfg(snd_tplg_t *tplg, snd_config_t *cfg,
	void *private)
{
	snd_config_iterator_t i, next;
	snd_config_t *n;
 ...
 * }
 */
static int parse_pcm(snd_tplg_t *tplg,
	snd_config_t *cfg, void *private ATTRIBUTE_UNUSED)
{
	struct snd_soc_tplg_pcm_dai *pcm_dai;
	struct tplg_elem *elem;
 ...
 * }
 */
static int parse_be(snd_tplg_t *tplg,
	snd_config_t *cfg, void *private ATTRIBUTE_UNUSED)
{
	struct snd_soc_tplg_pcm_dai *pcm_dai;
	struct tplg_elem *elem;
 ...
 * }
 */
static int parse_cc(snd_tplg_t *tplg,
	snd_config_t *cfg, void *private ATTRIBUTE_UNUSED)
{
	struct snd_soc_tplg_pcm_dai *pcm_dai;
	struct tplg_elem *elem;
...
static int parse_dapm_graph(snd_tplg_t *tplg, snd_config_t *cfg,
	void *private ATTRIBUTE_UNUSED)
{
	snd_config_iterator_t i, next;
	snd_config_t *n;
...
static int check_routes(snd_tplg_t *tplg)
{
...
static int check_controls(snd_tplg_t *tplg)
{
	struct list_head *base, *pos, *npos;
	struct tplg_elem *elem;
	int err = 0;
...
static int check_widgets(snd_tplg_t *tplg)
{
...
static int check_pcm_dai(snd_tplg_t *tplg,
	unsigned int type)
{
	struct list_head *base, *pos, *npos;
	struct tplg_elem *elem;
...
int snd_tplg_create(snd_tplg_t *tplg, const char *filename)
{
